...
/* ===== SIDE NAV ===== */
var _sfMO=false;
function _sfMT(){_sfMO=!_sfMO;var p=document.getElementById("_sfNavPanel"),o=document.getElementById("_sfOverlay");if(p)p.style.right=_sfMO?"0":"-285px";if(o)o.style.display=_sfMO?"block":"none";}
function _sfNG(t){_sfMO=false;var p=document.getElementById("_sfNavPanel"),o=document.getElementById("_sfOverlay");if(p)p.style.right="-285px";if(o)o.style.display="none";document.querySelectorAll("._ni").forEach(function(el){el.classList.remove("active");});var ab=document.querySelector("._ni[data-tab='"+t+"']");if(ab)ab.classList.add("active");if(typeof switchTab==="function")switchTab(t);if(t==="douyin")setTimeout(dyInit,100);}
function _sfOT(t){_sfMO=false;var p=document.getElementById("_sfNavPanel"),o=document.getElementById("_sfOverlay");if(p)p.style.right="-285px";if(o)o.style.display="none";var m=document.getElementById("_sfTModal"),c=document.getElementById("_sfTC");if(!m||!c)return;m.style.display="flex";var fns={cny:_sfTCny,ship:_sfTShip,agent:_sfTAgent,link:_sfTLink,ffcalc:_sfTFF,qc:_sfTQC,size:_sfTSize,duty:_sfTDuty,gloss:_sfTGloss};if(fns[t])fns[t](c);}
function _sfCT(){var m=document.getElementById("_sfTModal");if(m)m.style.display="none";var i=document.getElementById("_sfTInner");if(i){i.style.width="390px";i.style.maxHeight="86vh";}}
document.addEventListener("keydown",function(e){if(e.key==="Escape"){_sfCT();_sfMO=false;var p=document.getElementById("_sfNavPanel"),o=document.getElementById("_sfOverlay");if(p)p.style.right="-285px";if(o)o.style.display="none";}});
function _sH(t){return "<h3 style='color:#e2e8f0;margin:0 0 14px;font-size:16px;font-weight:700'>"+t+"</h3>";}
function _sI(id,ph){return "<input id='"+id+"' type='number' placeholder='"+ph+"' style='width:100%;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:9px 12px;border-radius:9px;font-size:13px;outline:none;box-sizing:border-box;margin-bottom:9px;font-family:inherit'>";}
function _sS(id,opts,oc){return "<select id='"+id+"'"+(oc?" onchange='"+oc+"()'":" ")+"style='width:100%;background:#060c18;border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:9px;border-radius:9px;font-size:13px;margin-bottom:9px;outline:none;font-family:inherit'>"+opts+"</select>";}
function _sB(l,fn){return "<button onclick='"+fn+"()' style='width:100%;padding:10px;background:linear-gradient(135deg,rgba(34,211,238,.18),rgba(99,102,241,.18));border:1px solid rgba(34,211,238,.32);color:#22d3ee;border-radius:9px;font-size:13px;cursor:pointer;font-weight:700;margin-bottom:9px;font-family:inherit'>"+l+"</button>";}
function _sO(id){return "<div id='"+id+"' style='font-size:15px;font-weight:700;text-align:center;padding:10px;min-height:36px;border-radius:9px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);margin-bottom:6px'></div>";}
function _sfTCny(el){el.innerHTML=_sH("CNY Converter")+_sI("_cn","Amount in CNY")+"<div style='display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:10px'><button onclick='_cCnv(\'USD\')' style='padding:9px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#94a3b8;border-radius:8px;font-size:12px;cursor:pointer;font-family:inherit'>USD</button><button onclick='_cCnv(\'EUR\')' style='padding:9px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#94a3b8;border-radius:8px;font-size:12px;cursor:pointer;font-family:inherit'>EUR</button><button onclick='_cCnv(\'GBP\')' style='padding:9px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#94a3b8;border-radius:8px;font-size:12px;cursor:pointer;font-family:inherit'>GBP</button></div>"+_sO("_cr")+"<p style='color:#1e293b;font-size:10px;margin:6px 0 0;text-align:center'>7.25/USD 7.8/EUR 9.1/GBP</p>";}
function _cCnv(to){var a=parseFloat((document.getElementById("_cn")||{}).value||0),r=document.getElementById("_cr");if(!a||!r){if(r)r.innerHTML="<span style='color:#ef4444'>Enter an amount</span>";return;}var rt={USD:7.25,EUR:7.8,GBP:9.1};r.innerHTML="<span style='color:#22d3ee;font-size:18px'>CNY "+a+" = "+to+" "+(a/rt[to]).toFixed(2)+"</span>";}
function _sfTShip(el){el.innerHTML=_sH("Shipping Estimator")+_sS("_shd","<option value='US'>USA</option><option value='UK'>UK</option><option value='EU'>Europe</option><option value='AU'>Australia</option><option value='CA'>Canada</option>",null)+_sS("_sht","<option value='.8'>Sneakers 800g</option><option value='.25'>T-Shirt 250g</option><option value='.6'>Hoodie 600g</option><option value='1.2'>Bag 1.2kg</option><option value='.9'>Jacket 900g</option><option value='0'>Custom</option>","_sShTy")+"<div id='_shcw' style='display:none'>"+_sI("_shkg","Weight kg")+"</div>"+_sB("Estimate","_sShC")+_sO("_shr");}
...
function _sShC(){var d=(document.getElementById("_shd")||{}).value||"US",tv=(document.getElementById("_sht")||{}).value||".8",w=tv==="0"?parseFloat((document.getElementById("_shkg")||{}).value||0):parseFloat(tv),r=document.getElementById("_shr");if(!w||!r){if(r)r.innerHTML="<span style='color:#ef4444'>Enter weight</span>";return;}var b={US:[8,18],UK:[10,22],EU:[9,20],AU:[12,25],CA:[10,22]}[d]||[8,18];r.innerHTML="<span style='color:#22c55e;font-size:16px'>Economy ~$"+Math.max(b[0],w*b[0]).toFixed(0)+"</span><span style='color:#475569;font-size:12px;margin-left:10px'>DHL ~$"+Math.max(b[1],w*b[1]).toFixed(0)+"</span>";}
function _sfTAgent(el){var ag=[{n:"Sugargoo",f:0,c:"#22c55e"},{n:"CNFans",f:0.015,c:"#22d3ee"},{n:"ACBuy",f:0,c:"#22c55e"},{n:"Kakobuy",f:0.03,c:"#22d3ee"},{n:"Pandabuy",f:0.05,c:"#f59e0b"},{n:"Superbuy",f:0.08,c:"#ef4444"}];window._sfAg=ag;var grid=ag.map(function(a,i){return "<div style='padding:10px;background:rgba(255,255,255,.04);border-radius:9px;text-align:center;border:1px solid rgba(255,255,255,.06)'><div style='color:#475569;font-size:10px;margin-bottom:5px'>"+a.n+"</div><div id='_ag"+i+"' style='color:"+a.c+";font-size:17px;font-weight:700'>-</div></div>";}).join("");el.innerHTML=_sH("Agent Fee Compare")+_sI("_agamt","Order total in CNY")+_sB("Compare","_sAgC")+"<div style='display:grid;grid-template-columns:1fr 1fr;gap:8px'>"+grid+"</div>";}
...
function _sfTLink(el){el.innerHTML=_sH("Agent Link Converter")+"<textarea id='_lnk' placeholder='Paste Taobao / Weidian / 1688 URL...' style='width:100%;height:72px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:9px;border-radius:9px;font-size:12px;resize:none;outline:none;box-sizing:border-box;margin-bottom:9px;font-family:inherit'></textarea>"+_sB("Generate Agent Links","_sLnkG")+"<div id='_lnkr'></div>";}
function _sLnkG(){var url=((document.getElementById("_lnk")||{}).value||"").trim(),r=document.getElementById("_lnkr");if(!url||!r){if(r)r.innerHTML="<span style='color:#ef4444'>Paste a URL first</span>";return;}var e=encodeURIComponent(url);r.innerHTML=[["CNFans","https://cnfans.com/?num="+e],["Kakobuy","https://www.kakobuy.com/item/details?url="+e],["Sugargoo","https://www.sugargoo.com/#/home/productDetail?productLink="+e],["ACBuy","https://acbuy.com/product?url="+e],["Pandabuy","https://www.pandabuy.com/product?url="+e],["Superbuy","https://www.superbuy.com/en/page/buy/?url="+e],["Hagobuy","https://www.hagobuy.com/item/details?url="+e],["Mulebuy","https://mulebuy.com/product/?url="+e]].map(function(a){return "<a href='"+a[1]+"' target='_blank' style='display:block;padding:9px 13px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:8px;color:#94a3b8;font-size:12px;text-decoration:none;margin-bottom:5px'>"+a[0]+" &#8594;</a>";}).join("");}
function _sfTQC(el){window._qcd={"Sneakers":["Toe box shape correct","Sole thickness correct","Stitching clean","Tongue label correct","Lace color matches","Box barcode correct","Insole correct","No glue marks"],"Clothing":["Tag position correct","Seams even","No loose threads","Material weight right","Zipper brand correct","Print placement correct"],"Bags":["Stitching matches retail","Hardware color correct","Zipper branded","Serial number correct","Lining correct","Leather smell natural"],"Watches":["Crown functions","Crystal clear","Caseback correct","Clasp locks","Dial text correct","Hands aligned"]};var btns=Object.keys(window._qcd).map(function(c){return "<button class='_qb' data-cat='"+c+"' onclick='_qcC(\'"+c+"\')' style='padding:6px 11px;border-radius:8px;font-size:12px;cursor:pointer;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);color:#64748b;margin:0 5px 7px 0;font-family:inherit'>"+c+"</button>";}).join("");el.innerHTML=_sH("QC Checklist")+btns+"<div id='_qcl'></div>";}
function _qcC(cat){document.querySelectorAll("._qb").forEach(function(b){b.style.background="rgba(255,255,255,.05)";b.style.color="#64748b";b.style.borderColor="rgba(255,255,255,.1)";});var ab=document.querySelector("._qb[data-cat='"+cat+"']");if(ab){ab.style.background="rgba(34,211,238,.15)";ab.style.color="#22d3ee";ab.style.borderColor="rgba(34,211,238,.3)";}var items=(window._qcd||{})[cat]||[];document.getElementById("_qcl").innerHTML=items.map(function(t,i){return "<label style='display:flex;gap:9px;align-items:flex-start;padding:8px 0;cursor:pointer;color:#94a3b8;font-size:13px;border-bottom:1px solid rgba(255,255,255,.04)'><input type='checkbox' onchange='_qcU("+items.length+")' style='margin-top:2px;accent-color:#22d3ee;flex-shrink:0'> "+t+"</label>";}).join("")+"<div id='_qcs' style='margin-top:9px;text-align:center;font-size:14px;font-weight:700;padding:8px;border-radius:8px;background:rgba(255,255,255,.03)'>0/"+items.length+"</div>";}
function _qcU(total){var n=document.querySelectorAll("#_qcl input:checked").length,el=document.getElementById("_qcs");if(!el)return;el.innerHTML="<span style='color:"+(n===total?"#22c55e":n>total*.6?"#f59e0b":"#ef4444")+"'>"+n+"/"+total+" "+(n===total?"Approve":"Review")+"</span>";}
function _sfTSize(el){window._szm=[["6","39","5.5","24"],["6.5","39.5","6","24.5"],["7","40","6.5","25"],["7.5","40.5","7","25.5"],["8","41","7.5","26"],["8.5","42","8","26.5"],["9","42.5","8.5","27"],["9.5","43","9","27.5"],["10","44","9.5","28"],["10.5","44.5","10","28.5"],["11","45","10.5","29"],["12","46","11.5","30"]];el.innerHTML=_sH("Size Converter")+_sS("_szus",window._szm.map(function(r){return "<option value='"+r[0]+"'>US "+r[0]+"</option>";}).join(""),"_sSzC")+"<div id='_szout' style='display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:4px'></div>";_sSzC();}
function _sSzC(){var us=((document.getElementById("_szus")||{}).value)||"6",row=(window._szm||[]).filter(function(r){return r[0]===us;})[0];if(!row)return;document.getElementById("_szout").innerHTML=[["EU",row[1]],["UK",row[2]],["CM",row[3]+"cm"],["US",row[0]]].map(function(v){return "<div style='background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:10px;padding:12px;text-align:center'><div style='color:#475569;font-size:9px;text-transform:uppercase;letter-spacing:.08em;margin-bottom:4px'>"+v[0]+"</div><div style='color:#22d3ee;font-size:26px;font-weight:700'>"+v[1]+"</div></div>";}).join("");}
function _sfTDuty(el){el.innerHTML=_sH("Customs Duty")+_sS("_dtd","<option value='800,0'>USA (under $800 free)</option><option value='135,20'>UK (over $135 = 20%)</option><option value='171,20'>EU (over $171 = 20%)</option><option value='740,10'>Australia 10%</option><option value='31,20'>Canada 20%</option>",null)+_sI("_dtv","Order value in USD")+_sB("Calculate","_sDtC")+_sO("_dtr")+"<p style='color:#334155;font-size:10px;margin-top:5px;text-align:center'>Rough estimate only</p>";}
...
function _sfTGloss(el){var t=[["W2C","Where to Cop"],["QC","Quality Check - reviewing agent photos"],["GL","Green Light - approve QC"],["1:1","Same quality as retail"],["Haul","Multiple items shipped together"],["PK","Top Putian batch"],["OG","High quality Jordan batch"],["LJR","Dongguan top batch"],["H12","Popular AJ1 batch"],["Chun Yuan","Pure Original - highest tier"],["Gong Si Ji","Company Grade - 95%+"],["Zhen Biao","True Label - real tags"],["Pu Tian","Putian city - sneaker capital"],["Middleman","Reseller 30-100% markup"],["CNFans","Agent - 0-1.5% fees"],["Sugargoo","Agent - 0% fees"],["MOQ","Minimum Order Quantity"],["Yupoo","Chinese photo album for catalogs"]];el.innerHTML=_sH("Rep Glossary")+t.map(function(r){return "<div style='padding:7px 0;border-bottom:1px solid rgba(255,255,255,.04)'><b style='color:#22d3ee;font-size:12px'>"+r[0]+"</b><div style='color:#64748b;font-size:11px;margin-top:2px'>"+r[1]+"</div></div>";}).join("");}
function _sfTFF(el){
  var inner=document.getElementById('_sfTInner');
  if(inner){inner.style.width='min(720px,95vw)';inner.style.maxHeight='92vh';}
  var h='';
  h+=_sH('FF Rate Calculator');
  h+='<p style="color:#475569;font-size:12px;margin:0 0 14px">Upload rate sheet. AI reads rates, estimates weights. All RMB.</p>';
  h+='<label for="_ffFile" style="display:block;border:2px dashed rgba(34,211,238,.3);border-radius:12px;padding:14px;text-align:center;margin-bottom:12px;cursor:pointer;background:rgba(34,211,238,.04)">';
  h+='<div style="font-size:24px;margin-bottom:4px">&#128247;</div>';
  h+='<div style="color:#22d3ee;font-size:13px;font-weight:600">Upload Rate Sheet Photo</div>';
  h+='<div style="color:#334155;font-size:11px;margin-top:2px">AI reads all rates automatically</div>';
  h+='<input type="file" id="_ffFile" accept="image/*" style="display:none" onchange="_ffLoad(this)"></label>';
  h+='<div id="_ffImgWrap" style="display:none;margin-bottom:12px;position:relative">';
  h+='<img id="_ffImgEl" style="width:100%;border-radius:10px;border:1px solid rgba(255,255,255,.1);max-height:180px;object-fit:contain;background:#000">';
  h+='<div id="_ffBadge" style="position:absolute;top:8px;right:8px;background:rgba(0,0,0,.85);border-radius:6px;padding:4px 9px;font-size:11px;color:#f59e0b;font-weight:600">Scanning...</div></div>';
  h+='<div id="_ffRBox" style="display:none;background:rgba(34,211,238,.05);border:1px solid rgba(34,211,238,.18);border-radius:10px;padding:11px;margin-bottom:12px">';
  h+='<div style="color:#22d3ee;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;margin-bottom:7px">Rates Detected (RMB/kg)</div>';
  h+='<div id="_ffRL"></div></div>';
  h+='<div style="color:#22d3ee;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;margin-bottom:9px">Your Items</div>';
  h+='<div id="_ffItems"><div class="_ffi" style="display:grid;grid-template-columns:1fr 60px 108px;gap:7px;margin-bottom:7px;align-items:center">';
  h+='<input class="_ffN" placeholder="Item e.g. Jordan 4" style="background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px 11px;border-radius:9px;font-size:13px;outline:none;box-sizing:border-box;font-family:inherit">';
  h+='<input class="_ffQ" type="number" placeholder="Qty" min="1" value="1" style="background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px;border-radius:9px;font-size:13px;outline:none;text-align:center;box-sizing:border-box;font-family:inherit">';
  h+='<select class="_ffS" style="background:#060c18;border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px;border-radius:9px;font-size:12px;outline:none;font-family:inherit"><option value="">Line...</option></select>';
  h+='</div></div>';
  h+='<div style="display:flex;gap:8px;margin-bottom:11px">';
  h+='<button onclick="_ffAdd()" style="flex:1;padding:8px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);color:#94a3b8;border-radius:9px;font-size:12px;cursor:pointer;font-family:inherit">+ Add Item</button>';
  h+='<button onclick="_ffCalc()" style="flex:2;padding:8px;background:linear-gradient(135deg,rgba(34,211,238,.2),rgba(99,102,241,.2));border:1px solid rgba(34,211,238,.35);color:#22d3ee;border-radius:9px;font-size:13px;cursor:pointer;font-weight:700;font-family:inherit">Calculate with AI</button>';
  h+='</div><div id="_ffRes"></div>';
  el.innerHTML=h;
}
...
function _ffScan(){var badge=document.getElementById("_ffBadge"),rb=document.getElementById("_ffRBox"),rl=document.getElementById("_ffRL");if(badge){badge.textContent="AI scanning...";badge.style.color="#f59e0b";}if(rb)rb.style.display="none";fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:800,messages:[{role:"user",content:[{type:"image",source:{type:"base64",media_type:window._ffM||"image/jpeg",data:window._ffB}},{type:"text",text:"Extract shipping lines and rates from this forwarder chart. Return ONLY JSON: [{line:string,rate:number}]. RMB units, convert USD at 7.25."}]}]})}).then(function(r){return r.json();}).then(function(d){try{var txt=(d.content||[]).map(function(b){return b.type==="text"?b.text:"";}).join("").replace(/```json|```/g,"").trim();var rates=JSON.parse(txt);window._ffRates=rates;var opts=rates.map(function(r){return "<option value='"+r.rate+"'>"+r.line+" ("+r.rate+" RMB/kg)</option>";}).join("");document.querySelectorAll("._ffS").forEach(function(s){s.innerHTML="<option value=''>Select line...</option>"+opts;});if(rl)rl.innerHTML=rates.map(function(r){return "<div style='display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid rgba(255,255,255,.05)'><span style='color:#94a3b8;font-size:12px'>"+r.line+"</span><span style='color:#22d3ee;font-size:12px;font-weight:700'>"+r.rate+" RMB/kg</span></div>";}).join("");if(rb)rb.style.display="block";if(badge){badge.textContent="Rates loaded";badge.style.color="#22c55e";}}catch(e){if(badge){badge.textContent="Could not read chart";badge.style.color="#ef4444";}}}).catch(function(){if(badge){badge.textContent="Scan failed";badge.style.color="#ef4444";}});}
function _ffAdd(){var list=document.getElementById("_ffItems");if(!list)return;var opts="<option value=''>Select line...</option>"+((window._ffRates||[]).map(function(r){return "<option value='"+r.rate+"'>"+r.line+" ("+r.rate+" RMB/kg)</option>";})).join("");var d=document.createElement("div");d.className="_ffi";d.style.cssText="display:grid;grid-template-columns:1fr 60px 108px 26px;gap:7px;margin-bottom:7px;align-items:center";d.innerHTML="<input class='_ffN' placeholder='Item' style='background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px 11px;border-radius:9px;font-size:13px;outline:none;box-sizing:border-box;font-family:inherit'><input class='_ffQ' type='number' placeholder='Qty' min='1' value='1' style='background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px;border-radius:9px;font-size:13px;outline:none;text-align:center;box-sizing:border-box;font-family:inherit'><select class='_ffS' style='background:#060c18;border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px;border-radius:9px;font-size:12px;outline:none;font-family:inherit'>"+opts+"</select><button onclick='this.closest("._ffi").remove()' style='background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.2);color:#f87171;border-radius:7px;cursor:pointer;font-size:13px;height:34px'>x</button>";list.appendChild(d);}
function _ffCalc(){var res=document.getElementById("_ffRes");if(!res)return;var items=[];document.querySelectorAll("._ffi").forEach(function(row){var n=(row.querySelector("._ffN")||{}).value||"",q=parseInt((row.querySelector("._ffQ")||{}).value||1),rate=parseFloat((row.querySelector("._ffS")||{}).value||0);if(n)items.push({name:n,qty:q,rate:rate});});if(!items.length){res.innerHTML="<span style='color:#ef4444'>Add at least one item</span>";return;}if(items.some(function(i){return !i.rate;})){res.innerHTML="<span style='color:#f59e0b'>Select a shipping line for every item</span>";return;}res.innerHTML="<div style='text-align:center;color:#f59e0b;padding:18px;font-size:13px'>AI estimating weights...</div>";var prompt="Estimate shipping weights. Return ONLY JSON: [{name,qty,kg_each,rate}]. Weights: sneakers 0.9, tshirt 0.25, hoodie 0.6, jacket 0.9, bag 0.8, hat 0.15, jeans 0.6. Items: "+items.map(function(i){return i.qty+"x "+i.name+" (rate:"+i.rate+")";}).join(", ");fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:600,messages:[{role:"user",content:prompt}]})}).then(function(r){return r.json();}).then(function(d){try{var txt=(d.content||[]).map(function(b){return b.type==="text"?b.text:"";}).join("").replace(/```json|```/g,"").trim();var parsed=JSON.parse(txt);var tR=0,tK=0,tI=0;var rows=parsed.map(function(it){var tkg=(it.kg_each||0)*it.qty,cost=tkg*(it.rate||0);tK+=tkg;tR+=cost;tI+=it.qty;return "<div style='display:flex;justify-content:space-between;align-items:center;padding:8px 11px;background:rgba(255,255,255,.04);border-radius:9px;margin-bottom:5px'><div><div style='color:#e2e8f0;font-size:13px;font-weight:600'>"+it.name+"</div><div style='color:#475569;font-size:11px'>x"+it.qty+" @ ~"+it.kg_each+"kg = "+tkg.toFixed(2)+"kg</div></div><div style='color:#22d3ee;font-size:14px;font-weight:700'>"+cost.toFixed(0)+" RMB</div></div>";}).join("");res.innerHTML="<div style='background:rgba(34,211,238,.05);border:1px solid rgba(34,211,238,.2);border-radius:12px;padding:13px'>"+rows+"<div style='border-top:1px solid rgba(34,211,238,.2);margin-top:9px;padding-top:9px'><div style='display:flex;justify-content:space-between;align-items:center'><span style='color:#94a3b8;font-size:13px'>"+tI+" items - "+tK.toFixed(2)+"kg</span><span style='color:#22c55e;font-size:22px;font-weight:700'>"+tR.toFixed(0)+" RMB</span></div><div style='text-align:right;color:#475569;font-size:12px;margin-top:3px'>approx $"+(tR/7.25).toFixed(0)+" USD</div></div></div>";}catch(e){res.innerHTML="<span style='color:#ef4444'>Calc failed.</span>";}}).catch(function(){res.innerHTML="<span style='color:#ef4444'>Request failed.</span>";});}
var _dyMode="supplier";var _dyQt=[{label:"Jordan Factory",brand:"Jordan",product:"球鞋 厂家 微信 莆田"},{label:"Nike Passing",brand:"Nike",product:"纯原 过验 PK版"},{label:"Supreme",brand:"Supreme",product:"厂家直销 一手货源"},{label:"LV Bags",brand:"LV",product:"包包 厂家 货源 微信"},{label:"Freight Agent",brand:"",product:"转运 集运 代发货 微信"},{label:"Wholesale",brand:"",product:"球鞋 批发 货源 一件代发"}];
function dyInit(){var qb=document.getElementById("dy-quick-btns");if(!qb||qb.children.length>0)return;_dyQt.forEach(function(t){var btn=document.createElement("button");btn.textContent=t.label;btn.style.cssText="padding:6px 14px;border-radius:20px;font-size:12px;cursor:pointer;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);color:#94a3b8;transition:all .2s;font-family:inherit";btn.onmouseover=function(){this.style.background="rgba(34,211,238,.1)";this.style.color="#22d3ee";};btn.onmouseout=function(){this.style.background="rgba(255,255,255,.05)";this.style.color="#94a3b8";};btn.onclick=function(){var bEl=document.getElementById("dy-brand"),pEl=document.getElementById("dy-product");if(bEl)bEl.value=t.brand;if(pEl)pEl.value=t.product;dySearch();};qb.appendChild(btn);});}
function dySetMode(mode){_dyMode=mode;document.querySelectorAll(".dy-mode").forEach(function(b){b.style.background="rgba(255,255,255,.05)";b.style.borderColor="rgba(255,255,255,.1)";b.style.color="#64748b";});var ab=document.querySelector(".dy-mode[data-mode='"+mode+"']");if(ab){ab.style.background="rgba(34,211,238,.15)";ab.style.borderColor="rgba(34,211,238,.3)";ab.style.color="#22d3ee";}}
...
function dySearch(){var brand=(document.getElementById("dy-brand")||{}).value||"",product=(document.getElementById("dy-product")||{}).value||"";if(!brand&&!product){var res=document.getElementById("dy-results");if(res)res.innerHTML="<div style='color:#ef4444;padding:16px;text-align:center'>Enter a brand or product first</div>";return;}var query=dyBuildQ(brand,product,_dyMode);window._dyQ=query;var qd=document.getElementById("dy-query-display"),qt=document.getElementById("dy-query-text");if(qd)qd.style.display="block";if(qt)qt.textContent=query;var res=document.getElementById("dy-results");if(!res)return;res.innerHTML="<div style='text-align:center;padding:20px;color:#94a3b8'>Building...</div>";var enc=encodeURIComponent(query);setTimeout(function(){res.innerHTML="<div style='background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:16px;margin-bottom:10px'><div style='color:#e2e8f0;font-size:14px;font-weight:700;margin-bottom:5px'>Douyin Web Search</div><div style='color:#475569;font-size:12px;margin-bottom:10px'>Check video descriptions and comments for WeChat numbers.</div><a href='https://www.douyin.com/search/"+enc+"' target='_blank' style='display:inline-block;padding:9px 18px;background:linear-gradient(135deg,rgba(34,211,238,.2),rgba(99,102,241,.2));border:1px solid rgba(34,211,238,.3);color:#22d3ee;border-radius:9px;font-size:13px;font-weight:700;text-decoration:none'>Open Douyin Search</a></div><div style='background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:16px'><div style='color:#e2e8f0;font-size:14px;font-weight:700;margin-bottom:8px'>Copy for Douyin App</div><div style='display:flex;gap:8px;align-items:center'><div style='flex:1;background:rgba(0,0,0,.3);border:1px solid rgba(255,255,255,.08);border-radius:8px;padding:9px;color:#94a3b8;font-size:12px;font-family:monospace;word-break:break-all'>"+query+"</div><button onclick='dyCopy(window._dyQ)' style='padding:9px 13px;background:rgba(34,211,238,.1);border:1px solid rgba(34,211,238,.25);color:#22d3ee;border-radius:8px;font-size:12px;cursor:pointer;white-space:nowrap;font-family:inherit'>Copy</button></div></div>";},350);}
...
function dyDownloadVideo(){var urlEl=document.getElementById("dy-video-url"),url=(urlEl?urlEl.value:"").trim(),res=document.getElementById("dy-video-result");if(!url){if(res)res.innerHTML="<div style='color:#ef4444;padding:12px;text-align:center'>Paste a Douyin video URL first</div>";return;}if(!res)return;res.innerHTML="<div style='text-align:center;padding:24px'><div style='font-size:32px;margin-bottom:8px'>&#9203;</div><div style='color:#f59e0b;font-size:14px;font-weight:600'>Downloading video...</div><div style='color:#475569;font-size:12px;margin-top:4px'>Fetching and scanning for WeChat IDs</div></div>";fetch("/api/douyin-video",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:url})}).then(function(r){return r.json();}).then(function(d){if(!d.ok){res.innerHTML="<div style='background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.2);border-radius:10px;padding:16px;color:#ef4444;text-align:center'>"+(d.error||"Download failed")+"</div>";return;}var wHTML="";if(d.wechats&&d.wechats.length){wHTML="<div style='background:rgba(34,211,238,.07);border:1px solid rgba(34,211,238,.2);border-radius:10px;padding:14px;margin-bottom:14px'><div style='color:#22d3ee;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;margin-bottom:10px'>WeChat IDs Found</div>"+d.wechats.map(function(w){return "<div style='display:flex;justify-content:space-between;align-items:center;background:rgba(0,0,0,.3);border-radius:8px;padding:9px 12px;margin-bottom:6px'><span style='color:#22d3ee;font-size:15px;font-weight:700;font-family:monospace'>"+w+"</span><button onclick='navigator.clipboard.writeText(""+w+"")' style='padding:5px 12px;background:rgba(34,211,238,.15);border:1px solid rgba(34,211,238,.3);color:#22d3ee;border-radius:6px;font-size:11px;cursor:pointer;font-family:inherit'>Copy</button></div>";}).join("")+"</div>";}else{wHTML="<div style='background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:10px;padding:12px;margin-bottom:14px;color:#475569;font-size:12px;text-align:center'>No WeChat IDs found in description</div>";}var dHTML=d.description?"<div style='background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:10px;padding:14px;margin-bottom:14px'><div style='color:#94a3b8;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px'>Description</div><div style='color:#e2e8f0;font-size:13px;line-height:1.6;white-space:pre-wrap'>"+d.description+"</div></div>":"";var sHTML="<div style='display:flex;gap:8px;margin-bottom:14px'><div style='flex:1;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:8px;padding:10px;text-align:center'><div style='color:#22d3ee;font-size:15px;font-weight:700'>"+(d.duration||0)+"s</div><div style='color:#334155;font-size:10px'>Duration</div></div><div style='flex:1;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:8px;padding:10px;text-align:center'><div style='color:#22d3ee;font-size:15px;font-weight:700'>"+(d.view_count||0).toLocaleString()+"</div><div style='color:#334155;font-size:10px'>Views</div></div><div style='flex:1;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:8px;padding:10px;text-align:center'><div style='color:#22d3ee;font-size:15px;font-weight:700'>"+(d.file_size_mb||0)+"MB</div><div style='color:#334155;font-size:10px'>Size</div></div></div>";var vsrc="data:video/"+(d.ext||"mp4")+";base64,"+d.video_b64;res.innerHTML="<div style='margin-bottom:14px'><div style='color:#94a3b8;font-size:11px;margin-bottom:6px'>By: "+d.author+"</div><video controls playsinline style='width:100%;border-radius:12px;background:#000;max-height:360px'><source src='"+vsrc+"' type='video/"+(d.ext||"mp4")+"'></video><a href='"+vsrc+"' download='douyin."+(d.ext||"mp4")+"' style='display:block;margin-top:8px;padding:9px;background:rgba(34,211,238,.1);border:1px solid rgba(34,211,238,.25);color:#22d3ee;border-radius:8px;font-size:12px;font-weight:600;text-align:center;text-decoration:none'>Download Video File</a></div>"+sHTML+wHTML+dHTML;}).catch(function(e){res.innerHTML="<div style='color:#ef4444;padding:12px;text-align:center'>Error: "+e.message+"</div>";});}