...
function _sfTCny(el){
  el.innerHTML="<div style='display:grid;grid-template-columns:1fr 1fr;gap:24px;align-items:start'>"+
    "<div><h3 style='color:#e2e8f0;font-size:16px;font-weight:700;margin:0 0 14px'>CNY Converter</h3>"+
    "<div style='background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:20px'>"+
    "<label style='color:#64748b;font-size:11px;text-transform:uppercase;letter-spacing:.06em;display:block;margin-bottom:6px'>Amount in CNY</label>"+
    _sI("_cn","e.g. 350")+"<div style='display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-top:4px'>"+
    "<button onclick='_cCnv(\"USD\")' class='_Bt' style='margin:0'>To USD</button>"+
    "<button onclick='_cCnv(\"EUR\")' class='_Bt' style='margin:0'>To EUR</button>"+
    "<button onclick='_cCnv(\"GBP\")' class='_Bt' style='margin:0'>To GBP</button>"+
    "</div></div></div>"+
    "<div><h3 style='color:#e2e8f0;font-size:16px;font-weight:700;margin:0 0 14px'>Result</h3>"+
    "<div style='background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:20px;min-height:120px;display:flex;align-items:center;justify-content:center'>"+
    _sO("_cr")+"</div>"+
    "<div style='margin-top:12px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:10px;padding:12px'>"+
    "<div style='color:#334155;font-size:11px;margin-bottom:6px'>Current rates (approx)</div>"+
    "<div style='display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;text-align:center'>"+
    "<div><div style='color:#22d3ee;font-size:14px;font-weight:700'>7.25</div><div style='color:#334155;font-size:10px'>CNY/USD</div></div>"+
    "<div><div style='color:#22d3ee;font-size:14px;font-weight:700'>7.80</div><div style='color:#334155;font-size:10px'>CNY/EUR</div></div>"+
    "<div><div style='color:#22d3ee;font-size:14px;font-weight:700'>9.10</div><div style='color:#334155;font-size:10px'>CNY/GBP</div></div>"+
    "</div></div></div></div>";
}
...
function _sfTFF(el){
  el.innerHTML="<div style='display:grid;grid-template-columns:1fr 1fr;gap:20px'><div><h3 style='color:#e2e8f0;font-size:16px;font-weight:700;margin:0 0 14px'>FF Rate Calculator</h3><label style='display:block;background:rgba(34,211,238,.1);border:1px solid rgba(34,211,238,.25);color:#22d3ee;padding:10px;border-radius:10px;text-align:center;cursor:pointer;margin-bottom:12px;font-size:13px;font-weight:600'>Upload Rate Sheet Photo<input type='file' accept='image/*' id='_ffImg' style='display:none' onchange='_ffPrev(this)'></label><div id='_ffPrevDiv' style='display:none;margin-bottom:12px'><img id='_ffPrevImg' style='width:100%;border-radius:10px;border:1px solid rgba(255,255,255,.1);max-height:220px;object-fit:contain;background:#000'></div><div style='background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:14px'><div style='color:#64748b;font-size:11px;margin-bottom:10px;text-transform:uppercase;letter-spacing:.06em'>Items</div><div id='_ffRows'><div class='_ffRow' style='display:grid;grid-template-columns:1fr 55px 65px 28px;gap:6px;margin-bottom:8px'><input class='_ffi _ffName' placeholder='Item (Jordan 4, Hoodie...)'><input class='_ffi _ffQty' type='number' placeholder='Qty' min='1' value='1'><input class='_ffi _ffKg' type='number' placeholder='kg' step='.1' min='.1'><button onclick='_ffRem(this)' style='background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.2);color:#f87171;border-radius:8px;cursor:pointer;font-size:14px'>x</button></div></div><button onclick='_ffAdd()' style='width:100%;padding:8px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);color:#94a3b8;border-radius:8px;font-size:12px;cursor:pointer;margin-top:4px'>+ Add Item</button></div></div><div><div style='background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:14px;margin-bottom:16px'><div style='color:#64748b;font-size:11px;margin-bottom:10px;text-transform:uppercase;letter-spacing:.06em'>Shipping Rate</div><select id='_ffRate' onchange='_ffRateSel()' class='_Se'><option value=''>Select rate per kg</option><option value='3'>$3/kg — Economy line</option><option value='5'>$5/kg — Standard</option><option value='8'>$8/kg — Express</option><option value='12'>$12/kg — DHL</option><option value='18'>$18/kg — FedEx</option><option value='custom'>Custom rate</option></select><input id='_ffCust' type='number' placeholder='Enter $/kg' style='display:none' class='_In'></div><button onclick='_ffCalc()' class='_Bt'>Calculate Total Shipping Cost</button><div id='_ffRes' style='margin-top:12px'></div></div></div>";
}