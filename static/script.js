...
function _sfTFF(el){var inner=document.getElementById("_sfTInner");if(inner){inner.style.width="min(720px,95vw)";inner.style.maxHeight="92vh";}var h="";h+=_sH("FF Rate Calculator");h+="<p style='color:#475569;font-size:12px;margin:0 0 14px'>Upload forwarder rate sheet. AI reads rates and estimates weights. All in RMB.</p>";h+="<div id="_ffClickZone" style='border:2px dashed rgba(34,211,238,.3);border-radius:12px;padding:14px;text-align:center;margin-bottom:12px;cursor:pointer;background:rgba(34,211,238,.04)'><div style='font-size:24px;margin-bottom:4px'>&#128247;</div><div style='color:#22d3ee;font-size:13px;font-weight:600'>Upload Rate Sheet Photo</div><div style='color:#334155;font-size:11px;margin-top:2px'>AI reads all rates automatically</div><input type='file' id='_ffFile' accept='image/*' style='display:none' onchange='_ffLoad(this)'></div>";h+="<div id='_ffImgWrap' style='display:none;margin-bottom:12px;position:relative'><img id='_ffImgEl' style='width:100%;border-radius:10px;border:1px solid rgba(255,255,255,.1);max-height:180px;object-fit:contain;background:#000'><div id='_ffBadge' style='position:absolute;top:8px;right:8px;background:rgba(0,0,0,.85);border-radius:6px;padding:4px 9px;font-size:11px;color:#f59e0b;font-weight:600'>Scanning...</div></div>";h+="<div id='_ffRBox' style='display:none;background:rgba(34,211,238,.05);border:1px solid rgba(34,211,238,.18);border-radius:10px;padding:11px;margin-bottom:12px'><div style='color:#22d3ee;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;margin-bottom:7px'>Rates Detected (RMB/kg)</div><div id='_ffRL'></div></div>";h+="<div style='color:#22d3ee;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;margin-bottom:9px'>Your Items</div>";h+="<div id='_ffItems'><div class='_ffi' style='display:grid;grid-template-columns:1fr 60px 108px;gap:7px;margin-bottom:7px;align-items:center'><input class='_ffN' placeholder='Item (e.g. Jordan 4)' style='background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px 11px;border-radius:9px;font-size:13px;outline:none;box-sizing:border-box;font-family:inherit'><input class='_ffQ' type='number' placeholder='Qty' min='1' value='1' style='background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px;border-radius:9px;font-size:13px;outline:none;text-align:center;box-sizing:border-box;font-family:inherit'><select class='_ffS' style='background:#060c18;border:1px solid rgba(255,255,255,.1);color:#e2e8f0;padding:8px;border-radius:9px;font-size:12px;outline:none;font-family:inherit'><option value=''>Line...</option></select></div></div>";h+="<div style='display:flex;gap:8px;margin-bottom:11px'><button onclick='_ffAdd()' style='flex:1;padding:8px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);color:#94a3b8;border-radius:9px;font-size:12px;cursor:pointer;font-family:inherit'>+ Add Item</button><button onclick='_ffCalc()' style='flex:2;padding:8px;background:linear-gradient(135deg,rgba(34,211,238,.2),rgba(99,102,241,.2));border:1px solid rgba(34,211,238,.35);color:#22d3ee;border-radius:9px;font-size:13px;cursor:pointer;font-weight:700;font-family:inherit'>Calculate with AI</button></div><div id='_ffRes'></div>";el.innerHTML=h;var z=document.getElementById("_ffClickZone");if(z)z.onclick=function(){document.getElementById("_ffFile").click();};}
