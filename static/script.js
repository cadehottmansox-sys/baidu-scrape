...
function _sfTFF(el){el.innerHTML="<h3 style='color:#e2e8f0;margin:0 0 14px;font-size:16px;font-weight:700'>FF Rate Calculator</h3><p style='color:#475569;font-size:13px'>Upload your forwarder rate sheet image, then add your items. AI will read the rates and estimate weights in RMB.</p><p style='color:#22d3ee;font-size:12px;margin-top:10px'>This feature uses the Claude API. Make sure you have uploaded a rate sheet first.</p>";}
